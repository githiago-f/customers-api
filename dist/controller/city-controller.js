...
var CityController = function (router, con) {
    var cityRepository = city_repository_1.CityRespositoryKNEX(con);
    ...
    router.post('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var city, created, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    city = portfolio_domain_1.City(req.body);
                    return [4 /*yield*/, cityRepository.create(city)];
                case 1:
                    created = _a.sent();
